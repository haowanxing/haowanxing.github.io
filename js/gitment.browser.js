...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      _utils.http.post('https://haowanxing.herokuapp.com/', {
        code: code,
        client_id: client_id,
